      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
        <form id="generator-form" onSubmit={handleSubmit(handleFormSubmit, onError)} className="space-y-8">
          ...
          <div className="space-y-5">
            ...
            {watchedMode === 'akm' && (
              <div className="space-y-1.5">
                <label className="block text-xs font-semibold text-slate-700">Level Kognitif (Otomatis Terpilih Semua)</label>
                <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 text-xs text-slate-600 space-y-2">
                  {watch('subject') === 'Literasi Membaca' ? (
                    <ul className="list-disc pl-4 space-y-1">
                      <li><span className="font-semibold">Menemukan Informasi (Access and Retrieve):</span> Mengidentifikasi dan mencari informasi tersurat dalam teks.</li>
                      <li><span className="font-semibold">Memahami (Interpret and Integrate):</span> Memahami informasi tersirat, menyimpulkan, dan mengintegrasikan bagian teks.</li>
                      <li><span className="font-semibold">Mengevaluasi dan Merefleksi (Evaluate and Reflect):</span> Menilai kredibilitas, format teks, dan mengaitkan isi teks dengan pengalaman diri.</li>
                    </ul>
                  ) : (
                    <ul className="list-disc pl-4 space-y-1">
                      <li><span className="font-semibold">Pemahaman (Knowing):</span> Mengingat, mendefinisikan, dan memahami konsep serta prosedur matematika.</li>
                      <li><span className="font-semibold">Penerapan (Applying):</span> Menggunakan pengetahuan matematika untuk menyelesaikan masalah kontekstual (rutin).</li>
                      <li><span className="font-semibold">Penalaran (Reasoning):</span> Menganalisis, menyintesis, dan merumuskan strategi untuk masalah non-rutin dengan penalaran.</li>
                    </ul>
                  )}
                </div>
              </div>
