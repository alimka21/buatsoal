    ...
    <div className="min-h-screen flex font-sans bg-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-slate-800 relative flex-col items-center justify-center p-12 text-white overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-lg">
          ...
          <h1 className="text-4xl font-bold mb-4 tracking-tight">PAKAR BUAT SOAL</h1>
          <h2 className="text-2xl font-light text-blue-200 mb-6">AI GENERATOR</h2>
          ...
          <div className="flex items-center gap-4 bg-white/10 px-6 py-3 rounded-full border border-white/10 backdrop-blur-sm">
             ...
             <div className="flex gap-3">
                <a href="#" className="text-blue-200 hover:text-white transition-colors"><Facebook size={18} /></a>
                <a href="#" className="text-blue-200 hover:text-white transition-colors"><Instagram size={18} /></a>
             </div>
          </div>

          <button className="mt-12 px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-full shadow-lg shadow-orange-500/30 transition-all transform hover:scale-105 flex items-center gap-2">
